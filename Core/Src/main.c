...
void keyCallback(KEY_TypedefHandle* key, KEY_ActionType action) {
    switch (action) {
        ...
        case KEY_ACTION_TRIPLE_CLICK:
            LOG_I("key1", "三击回调函数触发");
            __asm volatile ("udf #0");  // 触发 HardFault
            break;
...
static const KEY_Config_t key1_config = {
    .name           = "KEY1",
    .active_level   = 0,
    .callback       = NULL,
    .keyinfo        = &key1_info,
...
static const KEY_Config_t key2_config = {
    .name           = "KEY2",
    .active_level   = 0,
    .callback       = NULL,
    .keyinfo        = &key2_info,
...
static KEY_TypedefHandle key0;
static KEY_TypedefHandle key1;
static KEY_TypedefHandle key2;
