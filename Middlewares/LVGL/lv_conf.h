...
/* FSMC is 16-bit wide, no byte swap is needed when pushing RGB565 pixels */
...
#define LV_USE_KILL_OBJECT_LOGIC 1
#define LV_USE_GET_AREA_INFO 1
#define LV_USE_USER_DATA_SINGLE_LABEL 0
#define LV_USE_LABEL_REFROPEN_COUNT 1
#define LV_USE_LABEL_TEXT_SELECTION 0
#define LV_USE_OBJ_REALIGN 1
#define LV_USE_OBJ_ID_BUILTIN 1
#define LV_USE_OBJ_STYLE 1
#define LV_USE_OBJ_ID 0
#define LV_USE_OBJ_ID_CREATE_AUTO 0
#define LV_USE_FILESYSTEM 0
#define LV_USE_IMAGE_DECODE_MODIFIER 1
#define LV_USE_PERF_MONITOR 0
#define LV_USE_MEM_MONITOR 0
#define LV_USE_REFR_DEBUG 0
