...
#define LV_LOG_TRACE(...) do {}while(0)
#define LV_LOG_INFO(fmt, ...) do {LOG_I(TAG, fmt, ##__VA_ARGS__);}while(0)
#define LV_LOG_WARN(fmt, ...) do {LOG_W(TAG, fmt, ##__VA_ARGS__);}while(0)
#define LV_LOG_ERROR(fmt, ...)do {LOG_E(TAG, fmt, ##__VA_ARGS__);}while(0)
#define LV_LOG_USER(...) do {}while(0)
#define LV_LOG(...) do {}while(0)
