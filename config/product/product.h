...
#define CFG_FEAT_HAL_ADC        1 /* 启动 ADC 抽象 */
#define CFG_FEAT_HAL_RTC        1 /* 启动 RTC 抽象 */
#define CFG_FEAT_HAL_PWR        1 /* 启动 Power 抽象 */
...
/* HAL ADC/RTC/PWR 运行策略参数 */
#define CFG_PARAM_ADC_LOG_PORT_ERR        1 /* port->HAL 映射错误是否记录日志 */
#define CFG_PARAM_ADC_LOG_PORT_ERR_IN_ISR 0 /* 1: ISR中也打日志(谨慎) */
#define CFG_PARAM_RTC_LOG_PORT_ERR        1 /* port->HAL 映射错误是否记录日志 */
#define CFG_PARAM_RTC_LOG_PORT_ERR_IN_ISR 0 /* 1: ISR中也打日志(谨慎) */
#define CFG_PARAM_PWR_LOG_PORT_ERR        1 /* port->HAL 映射错误是否记录日志 */
#define CFG_PARAM_PWR_LOG_PORT_ERR_IN_ISR 0 /* 1: ISR中也打日志(谨慎) */
