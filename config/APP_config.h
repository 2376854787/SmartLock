...
#endif
#if ((CFG_PARAM_SPI_EVT_USE_EVENTBUS != 0) && (CFG_PARAM_SPI_EVT_USE_EVENTBUS != 1))
#error "CFG_PARAM_SPI_EVT_USE_EVENTBUS 必须为 0 或 1。"
#endif
...
#endif
#if (defined(CFG_PARAM_SPI_CB_IN_ISR) && (CFG_PARAM_SPI_CB_IN_ISR == 0)) && \
    (!defined(CFG_PARAM_SPI_EVT_USE_EVENTBUS) || (CFG_PARAM_SPI_EVT_USE_EVENTBUS != 1))
#error "CFG_PARAM_SPI_CB_IN_ISR=0 时，CFG_PARAM_SPI_EVT_USE_EVENTBUS 必须为 1。"
#endif
