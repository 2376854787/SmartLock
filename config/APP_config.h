...
#endif
#if ((CFG_FEAT_NV_STORAGE != 0) && (CFG_FEAT_NV_STORAGE != 1))
#error "CFG_FEAT_NV_STORAGE 必须为 0 或 1。"
#endif
...
#endif
#if ((CFG_FEAT_RC522 != 0) && (CFG_FEAT_RC522 != 1))
#error "CFG_FEAT_RC522 必须为 0 或 1。"
#endif
...
#endif
#if ((CFG_PARAM_SPI_CB_IN_ISR != 0) && (CFG_PARAM_SPI_CB_IN_ISR != 1))
#error "CFG_PARAM_SPI_CB_IN_ISR 必须为 0 或 1。"
#endif
#if ((CFG_PARAM_SPI_EVT_DISPATCH_MODE != CFG_PARAM_SPI_EVT_DISPATCH_EVENTBUS) && \
     (CFG_PARAM_SPI_EVT_DISPATCH_MODE != CFG_PARAM_SPI_EVT_DISPATCH_QUEUE) &&    \
     (CFG_PARAM_SPI_EVT_DISPATCH_MODE != CFG_PARAM_SPI_EVT_DISPATCH_TASK_NOTIFY))
#error "CFG_PARAM_SPI_EVT_DISPATCH_MODE 配置非法。"
#endif
#if (CFG_PARAM_SPI_EVT_DISPATCH_MODE == CFG_PARAM_SPI_EVT_DISPATCH_TASK_NOTIFY) &&              \
    ((CFG_PARAM_SPI_EVT_NOTIFY_FLAG_DONE | CFG_PARAM_SPI_EVT_NOTIFY_FLAG_ERROR |                \
      CFG_PARAM_SPI_EVT_NOTIFY_FLAG_STREAM_HALF | CFG_PARAM_SPI_EVT_NOTIFY_FLAG_STREAM_FULL) == \
     0u)
#error "SPI task-notify 事件 flags 不能全部为 0。"
#endif
#if ((CFG_PARAM_I2C_LOG_PORT_ERR != 0) && (CFG_PARAM_I2C_LOG_PORT_ERR != 1))
#error "CFG_PARAM_I2C_LOG_PORT_ERR 必须为 0 或 1。"
#endif
#if ((CFG_PARAM_I2C_LOG_PORT_ERR_IN_ISR != 0) && (CFG_PARAM_I2C_LOG_PORT_ERR_IN_ISR != 1))
#error "CFG_PARAM_I2C_LOG_PORT_ERR_IN_ISR 必须为 0 或 1。"
#endif
#if ((CFG_PARAM_I2C_CB_IN_ISR != 0) && (CFG_PARAM_I2C_CB_IN_ISR != 1))
#error "CFG_PARAM_I2C_CB_IN_ISR 必须为 0 或 1。"
#endif
#if ((CFG_PARAM_I2C_EVT_DISPATCH_MODE != CFG_PARAM_I2C_EVT_DISPATCH_EVENTBUS) && \
     (CFG_PARAM_I2C_EVT_DISPATCH_MODE != CFG_PARAM_I2C_EVT_DISPATCH_QUEUE) &&    \
     (CFG_PARAM_I2C_EVT_DISPATCH_MODE != CFG_PARAM_I2C_EVT_DISPATCH_TASK_NOTIFY))
#error "CFG_PARAM_I2C_EVT_DISPATCH_MODE 配置非法。"
#endif
#if (CFG_PARAM_I2C_EVT_DISPATCH_MODE == CFG_PARAM_I2C_EVT_DISPATCH_TASK_NOTIFY) && \
    ((CFG_PARAM_I2C_EVT_NOTIFY_FLAG_DONE | CFG_PARAM_I2C_EVT_NOTIFY_FLAG_ERROR) == 0u)
#error "I2C task-notify 事件 flags 不能全部为 0。"
#endif
...
#endif
#if ((CFG_PARAM_FLASH_LOG_PORT_ERR != 0) && (CFG_PARAM_FLASH_LOG_PORT_ERR != 1))
#error "CFG_PARAM_FLASH_LOG_PORT_ERR 必须为 0 或 1。"
#endif
...
#error "启用 CFG_FEAT_SOFT_I2C 时，CFG_FEAT_HAL_GPIO 必须为 1。"
    ...
    (!defined(CFG_FEAT_HAL_FLASH) || (CFG_FEAT_HAL_FLASH != 1))
#error "启用 CFG_FEAT_FLASH_PARTITION 时，CFG_FEAT_HAL_FLASH 必须为 1。"
#endif

#if (defined(CFG_FEAT_NV_STORAGE) && (CFG_FEAT_NV_STORAGE == 1)) && \
    (!defined(CFG_FEAT_FLASH_PARTITION) || (CFG_FEAT_FLASH_PARTITION != 1))
#error "启用 CFG_FEAT_NV_STORAGE 时，CFG_FEAT_FLASH_PARTITION 必须为 1。"
#endif

#if (defined(CFG_FEAT_NV_STORAGE) && (CFG_FEAT_NV_STORAGE == 1)) && \
    (!defined(CFG_FEAT_CRC16) || (CFG_FEAT_CRC16 != 1))
#error "启用 CFG_FEAT_NV_STORAGE 时，CFG_FEAT_CRC16 必须为 1。"
#endif
...
#if (defined(CFG_FEAT_RC522) && (CFG_FEAT_RC522 == 1)) && \
    (!defined(CFG_FEAT_HAL_SPI) || (CFG_FEAT_HAL_SPI != 1))
#error "启用 CFG_FEAT_RC522 时，CFG_FEAT_HAL_SPI 必须为 1。"
#endif

#if (defined(CFG_FEAT_RC522) && (CFG_FEAT_RC522 == 1)) && \
    (!defined(CFG_FEAT_HAL_GPIO) || (CFG_FEAT_HAL_GPIO != 1))
#error "启用 CFG_FEAT_RC522 时，CFG_FEAT_HAL_GPIO 必须为 1。"
#endif

#if (defined(CFG_FEAT_RC522) && (CFG_FEAT_RC522 == 1)) && \
    (!defined(CFG_FEAT_MEMORY_POOL) || (CFG_FEAT_MEMORY_POOL != 1))
#error "启用 CFG_FEAT_RC522 时，CFG_FEAT_MEMORY_POOL 必须为 1。"
#endif

#if (defined(CFG_FEAT_RC522) && (CFG_FEAT_RC522 == 1)) && \
    (!defined(CFG_FEAT_HFSM_SYSTEM) || (CFG_FEAT_HFSM_SYSTEM != 1))
#error "启用 CFG_FEAT_RC522 时，CFG_FEAT_HFSM_SYSTEM 必须为 1。"
#endif
