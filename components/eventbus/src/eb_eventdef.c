...
static const eb_eventdef_t g_defs[] = {
    ...
    /* ── RC522 ── */
    {EB_EVT_RC522_READY, EB_PLANE_CONTROL, EB_PRIO_M, EB_SEM_SNAPSHOT, EB_OVERWRITE, 0u,
     EB_STORM_NONE, 0u, 0u, 0u, 0u},

    {EB_EVT_RC522_CARD, EB_PLANE_CONTROL, EB_PRIO_M, EB_SEM_SNAPSHOT, EB_OVERWRITE, 0u,
     EB_STORM_NONE, 0u, 0u, 0u, 0u},

    {EB_EVT_RC522_CARD_LOST, EB_PLANE_CONTROL, EB_PRIO_M, EB_SEM_EDGE, EB_DROP_NEW, 0u,
     EB_STORM_NONE, 0u, 0u, 0u, 0u},

    {EB_EVT_RC522_ERROR, EB_PLANE_CONTROL, EB_PRIO_H, EB_SEM_EDGE, EB_DROP_NEW, 0u,
     EB_STORM_NONE, 0u, 0u, 0u, 0u},
};
