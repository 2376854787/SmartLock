...
// SD 数据块 CRC16 常用表（poly=0x1021, refin/refout=false）
static const uint16_t crc16_table_1021[256] = {
...
/* 默认配置 */
static const crc16_config_t g_crc16_config[] = {
    [MODBUS] = {.init = 0xFFFF, .poly = 0xA001, .isMsbFirst = false, .res_op_value = 0x0000},
    [CCITT]  = {.init         = 0x0000,
                .poly         = 0x1021,
                .isMsbFirst   = true,
                .res_op_value = 0x0000}, /* XMODEM */
    [USB] = {.init = 0xFFFF, .poly = 0xA001, .isMsbFirst = false, .res_op_value = 0xFFFF}, /* USB */
    [MAXIM] = {.init         = 0x0000,
               .poly         = 0xA001,
               .isMsbFirst   = false,
               .res_op_value = 0xFFFF}, /* MAXIM */
};

/* 全局配置个数 */
static const uint16_t config_count = sizeof(g_crc16_config) / sizeof(g_crc16_config[0]);
/**
...
static ret_code_t crc16_cal_table_impl(const crc16_config_t* cfg, const uint8_t* data,
    ...
    *out = (uint16_t)(crc ^ cfg->res_op_value);
    return RET_OK;
}
/**
